...
source("./Scripts/rpi.d.SeasonalWindows_New.R") #changes in 2019 analysis to accommodate the movement of the data manip function inside the time period loop. 
