...
# LOOP THROUGH TIME PERIODS
  ...
  tmp.dat <- subset(sp.dat, year %in% c(Y1:Y2))
  		...
  		data.model <- "nbinomial" 

  		trend <- try(inla(trend.formula, family = "zeroinflatednbinomial0", data = tmp.dat, E = DurationInHours,
...
# use same data distribution as for trends
  ...
  index <- NULL
  index <- try(inla(index.formula, family = "zeroinflatednbinomial0", data = sp.dat, E = DurationInHours,
